 ...
 */
public class Admin_Event_Booking_Module extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Event_Booking_Module
     */
    public Admin_Event_Booking_Module() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Manage Venue Booking");
        ...
        jLabel6.setText("Manage Ordering Food");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Event_Booking_Module.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Event_Booking_Module().setVisible(true);
            }
        });
    }
