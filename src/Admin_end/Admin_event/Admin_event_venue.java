 ...
 */
public class Admin_event_venue extends javax.swing.JFrame {

    /**
     * Creates new form Admin_event_venue
     */
    public Admin_event_venue() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Add a new Venue");

        jToggleButton1.setText("Press to add ");

        jLabel5.setText("2.");

        jLabel6.setText("Update an exsisting venue details");

        jToggleButton2.setText("Press to update ");

        jLabel7.setText("Delete a current exsisting venue");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_event_venue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_event_venue().setVisible(true);
            }
        });
    }
