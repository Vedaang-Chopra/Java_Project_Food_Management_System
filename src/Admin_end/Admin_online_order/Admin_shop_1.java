 ...
 */
public class Admin_shop_1 extends javax.swing.JFrame {

    /**
     * Creates new form Admin_shop_1
     */
    public Admin_shop_1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(210, 340, 65, 25);

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new Admin_shop_1_add().setVisible(true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new Admin_shop_1_delete().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_shop_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
