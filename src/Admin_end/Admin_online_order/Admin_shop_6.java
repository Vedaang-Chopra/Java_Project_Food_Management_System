 ...
 */
public class Admin_shop_6 extends javax.swing.JFrame {

    /**
     * Creates new form Admin_shop_6
     */
    public Admin_shop_6() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(260, 340, 90, 31);

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new Admin_shop_6_add().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_shop_6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
