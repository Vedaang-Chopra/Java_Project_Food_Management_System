 ...
 */
public class Admin_shop_3 extends javax.swing.JFrame {

    /**
     * Creates new form Admin_shop_3
     */
    public Admin_shop_3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(250, 350, 90, 31);

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new Admin_shop_3_add().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new Admin_shop_3_update().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new Admin_shop_3_delete().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_shop_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
