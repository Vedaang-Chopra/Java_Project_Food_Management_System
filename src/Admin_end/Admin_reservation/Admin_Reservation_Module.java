 ...
 */
public class Admin_Reservation_Module extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Reservation_Module
     */
    public Admin_Reservation_Module() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Add a new Reservation");

        jToggleButton1.setText("Press to add ");

        jLabel5.setText("2.");

        jLabel6.setText("Update an exsisting reservation");

        jToggleButton2.setText("Press to update ");

        jLabel7.setText("Delete a reservation");

        jLabel8.setText("3.");

        jToggleButton3.setText("Press to delete ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Reservation_Module.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Reservation_Module().setVisible(true);
            }
        });
    }
